...
GetWindowTextLengthA = user32.GetWindowTextA
GetWindowTextLengthA.argtypes = (wintypes.HANDLE, wintypes.LPSTR, wintypes.INT)
GetWindowTextLengthA.restype = wintypes.INT
...
ToAscii.argtypes = (wintypes.UINT, wintypes.UINT, POINTER(Keyboard_State), wintypes.LPDWORD, wintypes.UINT)
...
hook = SetWindowsHookExA(WH_KEYBAORD_LL, callback, 0, 0)
